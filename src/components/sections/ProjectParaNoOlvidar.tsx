      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center gap-4 mt-7">
          ...
          <a
            ...
            className="mt-4 px-6 py-2 rounded-full text-[#BD9C86] border-1 border-[#BD9C86] font-semibold shadow-md hover:shadow-lg transition duration-300 ease-in-out hover:scale-105 hover:text-[#a0806a]"
          >
            Visitar Sitio Web
          </a>
