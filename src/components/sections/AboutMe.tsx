...
const AboutMe = () => {
    return (
      <div className="bg-white py-8 md:py-10 px-4 md:px-0 w-full text-center">
        <h1 className="font-outfit text-[#BD9C86] text-3xl md:text-4xl font-bold mb-8">Sobre Mí</h1>
        <p className="font-dancing text-gray-800 text-xl md:text-2xl md:max-w-2xl mx-auto leading-relaxed mb-6">
        ...
        <div className="mt-6">
          <img src={sign} alt="Firma de Ana Belén" className="mx-auto w-24 md:w-36 lg:w-48" />
        </div>
      </div>
    );
}
